...
class BodyHeightAnalysisViewController: UIViewController {
    ...
    func testBodyHeightAnalysisChart() {
        ...
        let contentRect = CGRect(x: 0, y: 64, width: view.frame.width , height: 350)
        
        let chartView = DrawCharts.bodyHeightAnalysis(contentRect, data: unitsSold, labels: dataLabels)
